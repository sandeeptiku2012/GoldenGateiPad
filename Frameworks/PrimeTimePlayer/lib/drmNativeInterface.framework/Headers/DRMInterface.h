...
/* 
	You must link against the appropriate Access for iOS library for the Xcode you are using.
	There are two versions - one for use with XCode 4.5+, and one for use with XCode 3.2+.
	This code introduces a link-time check based on the right SDK being present.
	If you see one of the symbols below undefined at link time, you should be linking against the other version of the library.
*/
#include <Availability.h>
#if defined(__IPHONE_6_0)
#define DRMManager DRMManager_MUST_USE_IPHONEOS_6_0_SDK
#else
#define DRMManager DRMManager_MUST_USE_IPHONEOS_4_3_SDK
#endif
