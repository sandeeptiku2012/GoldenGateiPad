//
//  RowsSubscriptionViewController.m
//  GoldenGate
//
...
@interface RowsSubscriptionViewController ()
...
@implementation RowsSubscriptionViewController
...
{
    PrefetchingDataSource *dataSource = [PrefetchingDataSource createWithDataFetcher:[MyChannelsDataFetcher new]];
