...
- (void)updateFromVideo:(Video *)aVideo
{
    ...
    self.watchPreviewBadge.hidden       = YES;//aVideo == nil; // hid the preview label as all videos will be available for viewers
...
// commenting the following section as all videos will be available
